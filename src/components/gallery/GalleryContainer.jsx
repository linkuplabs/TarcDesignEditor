...
import GalleryActions from './GalleryActions';
 ...
 const GalleryContainer = (props) => {
  ...
  window.document.title = 'TARC';

  function refresh() {
    props.updateGalleryCards();
    props.getGalleryCards([], '', props.uid);
  }

  useEffect(() => {
    console.log("effect getting cards");
      ...
      let checkHeightInterval = setInterval(() => {
        ...
        if (
          ...
          if (props.isLoadingCards) {
            if (!props.isSearch) {
              props.getGalleryCards(props.cards, props.lastKey, props.uid);
            } else {
  ...
  console.log("gallery checker :",props);
    if (!props.endLoadData) {
      return (
